...
const Livros = {
  cidadelaDoCaos : {
    ...
    Salgueiros. Aluno brilhante do Grande Mago de Yore e um mestre da magia, s6 voce pode empreender uma missao que atinja o pr6prio cora ao do mundo de pesadelo de Balthus Dire. Que criaturas monstruosas esperam por voce la?
    Steve Jackson, co-fundador da Games Workshop, um sucesso absoluto, criou uma aventura emocionante de espada e feiti aria para voce, com um elaborado sistema de  combate,  uma variedade fascinante de encantos para usar e uma folha de resultados para registrar seus ganhos e perdas. Tudo que voce precisa e de dois dados, um lapis e uma borracha.
